...
// 매주 수요일 23:00 KST → 디스코드 운영진 채널 알림
// 매일 자정 → 종료된 면제 ended 상태로 자동 전환
//
// 환경변수 (Cloudflare 대시보드 또는 wrangler secret put):
//   SUPABASE_URL                — https://luglshrfkkeacmefnvlm.supabase.co (변수)
//   SUPABASE_SERVICE_KEY        — RLS 우회용 service_role 키 (Secret)
//   DISCORD_ABSENCE_WEBHOOK_URL — 운영진 채널 웹훅 (Secret, guild-join-notify와 같은 채널 추천)
// =====================================================
